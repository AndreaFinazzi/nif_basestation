...
docker exec --privileged -w "/workspace" -it iac_basestation /bin/bash -i -c 'colcon build --packages-select deep_orange_msgs bvs_msgs raptor_dbw_msgs joystick_vehicle_interface joystick_vehicle_interface_nodes userinput'
