...
RUN apt install -y ros-galactic-vision-msgs ros-galactic-tf-transformations ros-galactic-plotjuggler ros-galactic-rviz2
RUN apt install -y python3-pip
RUN pip install matplotlib transforms3d
RUN apt install -y ros-galactic-plotjuggler-ros
...
RUN echo "export ROS_DOMAIN_ID=55" >> ~/.bashrc
