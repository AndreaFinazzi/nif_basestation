...
ani1i = FuncAnimation(vis.fig, vis.update_plot1i, init_func=vis.plot_init1i, interval=100)
...
ani2p = FuncAnimation(vis.fig, vis.update_plot2p, init_func=vis.plot_init2p, interval=100)
ani2y = FuncAnimation(vis.fig, vis.update_plot2y, init_func=vis.plot_init2y, interval=100)
